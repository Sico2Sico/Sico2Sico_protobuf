...
final public class GifrMessage : GeneratedMessage {

    public static func == (lhs: GifrMessage, rhs: GifrMessage) -> Bool {
        if lhs === rhs {
            return true
        }
        var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
        fieldCheck = fieldCheck && (lhs.hasUser == rhs.hasUser) && (!lhs.hasUser || lhs.user == rhs.user)
        fieldCheck = fieldCheck && (lhs.hasGifname == rhs.hasGifname) && (!lhs.hasGifname || lhs.gifname == rhs.gifname)
    ...
    public fileprivate(set) var user:UserInfo!
    public fileprivate(set) var hasUser:Bool = false
    public fileprivate(set) var gifname:String! = nil
    public fileprivate(set) var hasGifname:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        ...
        if hasGifname {
            try codedOutputStream.writeString(fieldNumber: 2, value:gifname)
        }
        if hasGiftUrl {
    ...
    override public func serializedSize() -> Int32 {
        ...
        if hasGifname {
            serialize_size += gifname.computeStringSize(fieldNumber: 2)
        }
        if hasGiftUrl {
    ...
    public class func getBuilder() -> GifrMessage.Builder {
        return GifrMessage.classBuilder() as! GifrMessage.Builder
    }
    public func getBuilder() -> GifrMessage.Builder {
        return classBuilder() as! GifrMessage.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
        return GifrMessage.Builder()
    }
    override public func classBuilder() -> ProtocolBuffersMessageBuilder {
        return GifrMessage.Builder()
    }
    public func toBuilder() throws -> GifrMessage.Builder {
        return try GifrMessage.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:GifrMessage) throws -> GifrMessage.Builder {
        return try GifrMessage.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
        guard isInitialized() else {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message")
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> GifrMessage {
        return try GifrMessage.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> GifrMessage {
        return try GifrMessage.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasUser {
    ...
    override public var hashValue:Int {
        get {
            ...
            if hasGifname {
                hashCode = (hashCode &* 31) &+ gifname.hashValue
            }
            if hasGiftUrl {
    ...
    final public class Builder : GeneratedMessageBuilder {
        fileprivate var builderResult:GifrMessage = GifrMessage()
        public func getMessage() -> GifrMessage {
            return builderResult
        }
        ...
        @discardableResult
        public func setUser(_ value:UserInfo!) -> GifrMessage.Builder {
            self.user = value
            return self
        }
        @discardableResult
        public func mergeUser(value:UserInfo) throws -> GifrMessage.Builder {
            if builderResult.hasUser {
                builderResult.user = try UserInfo.builderWithPrototype(prototype:builderResult.user).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.user = value
        ...
        @discardableResult
        public func clearUser() -> GifrMessage.Builder {
            userBuilder_ = nil
            builderResult.hasUser = false
            builderResult.user = nil
            return self
        ...
        public var gifname:String {
            get {
                return builderResult.gifname
            }
            set (value) {
                builderResult.hasGifname = true
                builderResult.gifname = value
            }
        }
        public var hasGifname:Bool {
            get {
                return builderResult.hasGifname
            }
        }
        @discardableResult
        public func setGifname(_ value:String) -> GifrMessage.Builder {
            self.gifname = value
            return self
        }
        @discardableResult
        public func clearGifname() -> GifrMessage.Builder{
            builderResult.hasGifname = false
            builderResult.gifname = nil
            return self
        }
        ...
        @discardableResult
        public func setGiftUrl(_ value:String) -> GifrMessage.Builder {
            self.giftUrl = value
            return self
        }
        @discardableResult
        public func clearGiftUrl() -> GifrMessage.Builder{
        ...
        @discardableResult
        public func setGiftCount(_ value:String) -> GifrMessage.Builder {
            self.giftCount = value
            return self
        }
        @discardableResult
        public func clearGiftCount() -> GifrMessage.Builder{
        ...
        @discardableResult
        override public func clear() -> GifrMessage.Builder {
            builderResult = GifrMessage()
            return self
        }
        override public func clone() throws -> GifrMessage.Builder {
            return try GifrMessage.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> GifrMessage {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> GifrMessage {
            let returnMe:GifrMessage = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:GifrMessage) throws -> GifrMessage.Builder {
            if other == GifrMessage() {
                return self
            }
            if (other.hasUser) {
                try mergeUser(value: other.user)
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> GifrMessage.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GifrMessage.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
            while (true) {
                let protobufTag = try codedInputStream.readTag()
                switch protobufTag {
                ...
                case 18:
                    gifname = try codedInputStream.readString()
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> GifrMessage.Builder {
            let resultDecodedBuilder = GifrMessage.Builder()
            if let jsonValueUser = jsonMap["user"] as? Dictionary<String,Any> {
                resultDecodedBuilder.user = try UserInfo.Builder.decodeToBuilder(jsonMap:jsonValueUser).build()

            }
            if let jsonValueGifname = jsonMap["gifname"] as? String {
                resultDecodedBuilder.gifname = jsonValueGifname
            }
        ...
        override class public func fromJSONToBuilder(data:Data) throws -> GifrMessage.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try GifrMessage.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }
...
extension GifrMessage: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<GifrMessage> {
        var mergedArray = Array<GifrMessage>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> GifrMessage? {
        return try GifrMessage.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> GifrMessage {
        return try GifrMessage.Builder().mergeFrom(data: data, extensionRegistry:ImmessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> GifrMessage {
        return try GifrMessage.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> GifrMessage {
        return try GifrMessage.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> GifrMessage {
        return try GifrMessage.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> GifrMessage {
        return try GifrMessage.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GifrMessage {
        return try GifrMessage.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
    public subscript(key: String) -> Any? {
        switch key {
        case "user": return self.user
        case "gifname": return self.gifname
...
extension GifrMessage.Builder: GeneratedMessageBuilderProtocol {
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "user": return self.user
        ...
        set (newSubscriptValue) { 
            ...
            case "gifname":
                ...
                self.gifname = newSubscriptValue
            case "giftUrl":
                guard let newSubscriptValue = newSubscriptValue as? String else {
                    return
                }
